...
import { searchLegalDatabase, formatContextForAI, getSectionCitation } from './lib/legalSearch'
...
// ─── API Configuration ─────────────────────────────────────────────────────────
const SARVAM_API_KEY  = 'sk_94c68d88_sG6mV6E3jBxywP6Dl9ikAgyV'
const GEMINI_API_KEY  = 'AIzaSyAl2m0WbcRvqipDVnJgzLHiIWojEBOFnQY'
...
// AI Model configs
const AI_MODELS = {
  deepseek: { id: 'deepseek', label: 'DeepSeek V3',       icon: '⚡', pill: 'deepseek', desc: 'Fast & highly accurate for legal analysis' },
  gemini:   { id: 'gemini',   label: 'Gemini Flash',  icon: '✨', pill: 'gemini',   desc: 'Google AI with strong multilingual reasoning' },
}
